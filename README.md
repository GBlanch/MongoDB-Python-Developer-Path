...
This learning path contains a series of hands-on courses about the core MongoDB skills. In this path, I learnt the basics of building modern applications with Python, using MongoDB as a database.
